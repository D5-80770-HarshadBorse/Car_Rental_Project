              ...
              <div className="logo footer__logo__container mb-4">
                <h1>
                  <Link to="/home" className="footer__logo">
                    ...
                    <strong>CarWala</strong> <br /><small>Rent Car Service</small> 
                    </span>
                  </Link>
                </h1>
            ...
            <Col lg="3" md="4" sm="6">
              <div className="mb-4">
                ...
                <p className="head__office">
                  SUNBEAM, Hinjewadi Phase III
                </p>
                <p className="head__office">Phone: +91 9665334034 </p>
                <p className="head__office">Email: harshadborse@gmail.com</p>
            ...
            <Col>
              <div className="footer__bottom">
                <p className="section__description pt-4 fw-bold text-center d-flex align-items-center justify-content-center gap-1">
                  ...
                  <span>Harshad Borse</span>. All Rights Reserved
                </p>
              </div>
            </Col>
          </Row>
